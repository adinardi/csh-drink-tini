...
commlinktest: compile
	$(TINICONVLINE) -f OneWireCommands.class -f OneWireLightShow.class -f SlotMonitorListener.class -f CommLink.class -f IncomingLink.class -f OutgoingLink.class -f ConfigMgr.class -f Starter.class -f TempWorker.class -m Starter -o Starter.tini 
clean: 
	rm *.class *.tini
